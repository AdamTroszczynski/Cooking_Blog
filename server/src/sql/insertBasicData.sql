...
INSERT INTO recipes (recipeId, recipeName, created, difficultLevelId, dishTypeId, userId, steps, ingredients, recipeImage, likesCount)
  VALUES
    ...
    (4, 'Chicken Noodle Soup', CURRENT_TIMESTAMP, 2, 6, 4, 'Boil chicken|Chop vegetables|Cook noodles', 'Chicken/1 lb|Carrots/3|Noodles/200g', 'ChickenNoodleSoup.jpg', 0),
    ...
    (7, 'Mango Smoothie', CURRENT_TIMESTAMP, 1, 6, 3, 'Blend mango|Add yogurt|Blend again', 'Mango/1|Yogurt/1 cup|Ice cubes/5', 'MangoSmoothie.jpg', 0),
    ...
    (9, 'Pancakes', CURRENT_TIMESTAMP, 1, 1, 2, 'Mix flour and milk|Cook on griddle', 'Flour/1.5 cups|Milk/1 cup|Eggs/2', 'Pancakes.jpg', 0),
    (10, 'Omelette', CURRENT_TIMESTAMP, 1, 3, 5, 'Beat eggs|Add fillings|Cook in pan', 'Eggs/3|Mushrooms/1 cup|Cheese/0.5 cup', 'Omelette.jpg', 0);
